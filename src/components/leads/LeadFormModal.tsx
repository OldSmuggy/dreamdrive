...
export default function LeadFormModal({
  ...
  const modalSubtitle = subtitle ?? (leadType === 'deposit_intent'
    ? "We'll contact you to arrange the $500 refundable deposit and secure this van."
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  {leadType === 'deposit_intent' && (
                    <div className="bg-amber-50 border border-amber-200 rounded-lg px-4 py-3 text-xs text-amber-800">
                      No payment taken here. We will contact you to arrange the $500 refundable deposit and lock in this van.
                    </div>
                  )}
