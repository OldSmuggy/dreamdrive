...
export default function DepositHoldButton({ listing, userId }: Props) {
  ...
  const ctaLabel =
    listing.source === 'auction' ? 'Hold This Van — $2,750 Deposit'
            ...
            {success ? (
              <div className="text-center py-4">
                ...
                <p className="text-gray-500 text-sm mb-6">
                  We&apos;ll be in touch within 1 business day to process your $2,750 deposit payment and confirm your hold.
                </p>
              ...
              <>
                ...
                <div className="bg-cream rounded-xl p-4 mb-5 space-y-2 text-sm text-gray-700">
                  <p>✓ &nbsp;$2,750 deposit holds this van for up to 7 days</p>
