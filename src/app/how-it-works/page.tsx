  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-16">
        <h1 className="font-display text-4xl text-forest-900 mb-4">How It Works</h1>
