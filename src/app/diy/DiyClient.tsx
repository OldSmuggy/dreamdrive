        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex gap-8 mb-8">
              <div><p className="font-display text-3xl text-forest-700">$11,900</p><p className="text-gray-400 text-xs mt-0.5">ex GST</p></div>
              <div><p className="font-display text-3xl text-forest-700">10 days</p><p className="text-gray-400 text-xs mt-0.5">turnaround</p></div>
              <div><p className="font-display text-3xl text-forest-700">+600mm</p><p className="text-gray-400 text-xs mt-0.5">standing height</p></div>
            </div>
