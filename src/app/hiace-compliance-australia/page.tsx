...
const steps = [
  {
    ...
    detail: 'Before the van even leaves Japan, we apply for a Vehicle Import Approval through the Australian Border Force. This is a government permit that authorises the import. Without it, customs won\'t release the vehicle. We handle this as part of the $2,500 + GST Bare Camper fee — which covers both our Japan buyer\'s agent and the Australia-side brokerage.',
