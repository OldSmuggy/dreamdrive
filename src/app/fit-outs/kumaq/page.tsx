...
const HERO_IMAGE = 'https://images.squarespace-cdn.com/content/v1/6452ed7189507b42ec70bffd/1683156338722-2KFOTMHKJGX47F9YGRQD/DSC06470.jpg'
    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-forest-950 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <img src={HERO_IMAGE} alt="KUMAQ" className="w-full h-full object-cover opacity-30" />
        </div>
