...
const HERO_IMAGE = 'https://images.squarespace-cdn.com/content/v1/6452ed7189507b42ec70bffd/d6b9a9af-7080-46b6-9d0c-03a76d5bf323/IMG_3103.jpeg'
    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-forest-950 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <img src={HERO_IMAGE} alt="MANA Pop Top" className="w-full h-full object-cover opacity-30" />
        </div>
