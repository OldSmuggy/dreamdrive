    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-forest-950 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <img src={HERO_IMAGE} alt="TAMA Pop Top" className="w-full h-full object-cover opacity-30" />
        </div>
        <div className="relative max-w-6xl mx-auto px-4 py-20 md:py-28">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="font-display text-5xl md:text-6xl text-white mb-3">The TAMA Pop Top</h1>
            <p className="text-sand-300 text-xl mb-8">Premium Handcrafted Campervan</p>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        <div className="max-w-3xl">
          <h2 className="font-display text-3xl text-forest-900 mb-4">About the TAMA</h2>
            ...
            {[
              {
                ...
                desc: 'Waterproof canvas with zip-open insect nets for airflow. Reading light in the ceiling.',
              },
              {
                title: 'Lift-Up Bed for Standing Room',
                desc: 'Bed platform lifts on gas struts to create more standing room and hold bedding.',
              },
              {
                title: 'Heavy Duty Pop Top',
                desc: 'We replace the entire roof for longevity. Streamlined finish with front taper for better aerodynamics.',
              },
            ].map(c => (
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8">
            ...
            <ul className="space-y-3 text-sm text-gray-700">
              {[
                ...
                '4x4 upgrade: 2.8L Turbo Diesel (+$7,000)',
                'Same engine as Land Cruiser Prado',
                '12% shorter exterior, 10% more rear cabin space vs competitors',
                '2026 model H200 still available from our Japan factory',
              ].map(item => (
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="font-display text-3xl text-forest-900 mb-2">Layout Options</h2>
          <p className="text-gray-500 mb-10">4 layouts to suit your lifestyle.</p>
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              {
                num: '01',
                title: 'Bed & Galley Kitchen',
                desc: 'Classic Tama setup — 70cm single bed extending to 110cm double. 40L Engel fridge with walnut countertop, sink, shower attachment. Storage under the bed platform.',
              },
              {
                num: '02',
                title: 'Extra Seat or Toilet Layout',
                desc: 'Forward-facing seat with 3 seatbelts for passengers, converts to lounge or extra bed. Or choose the vanlife layout with bench seat, slide-out table, hidden toilet and extra storage.',
              },
              {
                num: '03',
                title: 'Hotel on Wheels Layout',
                desc: 'Fixed full-size double bed with two large slide-out storage drawers. Internal slider for fridge or toilet.',
              },
              {
                num: '04',
                title: 'NICO Kitchen/Dining',
                desc: 'Inside/outside accessible sink, fresh & grey water tanks, bench seat and dining table for two.',
              },
            ].map(l => (
              <div key={l.num} className="bg-white border border-gray-200 rounded-2xl p-7">
                <span className="font-display text-4xl text-forest-200 block mb-2">{l.num}</span>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="mt-5 bg-sand-50 border border-sand-200 rounded-xl px-4 py-3 text-sm text-gray-700">
          ...
          {/* Interior specs */}
          <div>
            <h2 className="font-display text-3xl text-forest-900 mb-6">Interior Specifications</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wide mb-3">Standard Fit-Out</h3>
                <ul className="space-y-1.5 text-sm text-gray-700">
                  {[
                    '3 transforming rear seats',
                    'Modular bed kit',
                    '40L fridge',
                    'Walnut countertop, sink & faucet',
                    '10L fresh water tank (optional 40L)',
                    'Portable table',
      ...
      <section className="bg-forest-950 text-white py-16 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="font-display text-4xl text-white mb-3">Ready to build your TAMA?</h2>
